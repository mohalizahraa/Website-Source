...
-- Admin-editable runtime config; a row overrides the env default. See schema.sql.
CREATE TABLE IF NOT EXISTS settings (
    name  TEXT PRIMARY KEY,
    value TEXT
);

-- Append-only spend log for per-user quotas + a global cap; see schema.sql.
...
-- Granular per-call attribution (observability, not billing); see schema.sql.
